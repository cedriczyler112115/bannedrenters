...
<body class="min-h-screen bg-[#f5f7f5] text-slate-900">
    ...
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:py-10">
        <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <details data-banned-modal class="group relative sm:w-auto" @if($errors->any()) open @endif>
            ...
            <div data-registry-results>
                ...
                <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                    @forelse ($records as $record)
                        <article class="group overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-lg">
                            @if ($record->license)
